...
const AddInventory = () => {
  ...
  const { values, errors, dirty, handleSubmit, getFieldProps, touched } =
    useFormik({
        ...
        id
          ? dispatch(
              updateInventory({
                ...
                id,
                onSuccess: () => {
                  toast.success(t('table.inventory_updated'), {
                    autoClose: 2000,
                  });
                  setTimeout(() => {
                    navigate('/');
          ...
          : dispatch(
              createInventory({
                ...
                limit: numRows,
                onSuccess: () => {
                  toast.success(t('table.inventory_added'), {
                    autoClose: 2000,
                  });
                  setTimeout(() => {
                    navigate('/');
        ...
        <div className="form-group mb-1">
          ...
          <input
            ...
            className={`form-control ${
              (errors.name_en && touched.name_en) || stateErrors?.name_en
                ? 'is-invalid'
                : ''
            }`}
          />
          {(errors.name_en && touched.name_en) ||
            (stateErrors?.name_en && (
              <span className="text-danger">
                {errors.name_en || stateErrors?.name_en}
              </span>
            ))}
        </div>
        <div className="form-group mb-1">
          ...
          <input
            {...getFieldProps('name_ka')}
            name="name_ka"
            id="name_ka"
            type="text"
            className={`form-control ${
              (errors.name_ka && touched.name_ka) || stateErrors?.name_ka
                ? 'is-invalid'
                : ''
            }`}
          />
          {(errors.name_ka && touched.name_ka) ||
            (stateErrors?.name_ka && (
              <span className="text-danger">
                {errors.name_ka || stateErrors?.name_ka}
              </span>
            ))}
        </div>
        <div className="form-group mb-1">
          ...
          <input
            ...
            type="number"
            className={`form-control ${
              (errors.price && touched.price) || stateErrors?.price
                ? 'is-invalid'
                : ''
            }`}
            id="price"
          ...
          {(errors.price && touched.price) ||
            (stateErrors?.price && (
              <span className="text-danger">
                {errors.price || stateErrors?.price}
              </span>
            ))}
        </div>
        <div className="form-group">
          ...
          <select
            ...
            className={`form-select ${
              (errors.location && touched.location) || stateErrors?.location
                ? 'is-invalid'
                : ''
            }`}
          >
            <option disabled value="">
              {t('table.choose_location')}
            </option>
          ...
          {(errors.location && touched.location) ||
            (stateErrors?.location && (
              <span className="text-danger">
                {errors.location || stateErrors?.location}
              </span>
            ))}
        </div>
        <button
          ...
          disabled={
            !dirty || Object.keys(errors).length > 0 || createInventoryPending
          }
          type="submit"
